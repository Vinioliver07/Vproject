      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#0f172a]/90 backdrop-blur-md py-4 shadow-lg border-b border-white/5' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#services" className="text-sm font-medium hover:text-brand-light transition-colors">Serviços</a>
            <a href="#portfolio" className="text-sm font-medium hover:text-brand-light transition-colors">Portfólio</a>
            <a href="#contact">
        ...
        {isMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-[#0f172a] border-b border-white/10 p-6 flex flex-col space-y-4 md:hidden animate-fade-in shadow-2xl">
            ...
            <a href="#services" onClick={() => setIsMenuOpen(false)} className="text-lg font-medium">Serviços</a>
            <a href="#portfolio" onClick={() => setIsMenuOpen(false)} className="text-lg font-medium">Portfólio</a>
